    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTapi-auth-logout">Logout a user</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-GETapi-auth-user">
                                <a href="#authentication-GETapi-auth-user">Get the current user</a>
                            </li>
                                                                        </ul>
                            </ul>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;user&quot;: {
        ...
        &quot;created_at&quot;: &quot;2026-04-05T00:00:00.000000Z&quot;,
        &quot;updated_at&quot;: &quot;2026-04-05T00:00:00.000000Z&quot;
    }
}</code>
 </pre>
    </span>
...
<p>The user's password. Example: <code>password123</code></p>
                    ...
                    <h2 id="authentication-POSTapi-auth-logout">Logout a user</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="authentication-GETapi-auth-user">Get the current user</h2>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>APIs for managing posts</p>
                                ...
                                <h2 id="posts-GETapi-posts">List all posts</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/posts?filter%5Btitle%5D=Laravel&amp;filter%5Bcontent%5D=API&amp;sort=title%2C-created_at&amp;page=1&amp;per_page=10" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="filter[title]"                data-endpoint="GETapi-posts"
               value="Laravel"
               data-component="query">
    <br>
<p>Filter posts by title. Example: <code>Laravel</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>filter[content]</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="filter[content]"                data-endpoint="GETapi-posts"
               value="API"
               data-component="query">
    <br>
<p>Filter posts by content. Example: <code>API</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Sort posts by field. Example: <code>title,-created_at</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<p>Number of items per page. Example: <code>10</code></p>
                    ...
                    <h2 id="posts-POSTapi-posts">Create a new post</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The post title. Example: <code>Laravel API</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="Building APIs with Laravel"
               data-component="body">
    <br>
<p>The post content. Example: <code>Building APIs with Laravel</code></p>
        </div>
        </form>

                    <h2 id="posts-GETapi-posts--id-">Get a single post</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/posts/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>The post ID. Example: <code>1</code></p>
                    ...
                    <h2 id="posts-PUTapi-posts--id-">Update a post</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="Updated Laravel API"
               data-component="body">
    <br>
<p>The post title. Example: <code>Updated Laravel API</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>content</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The post content. Example: <code>Updated content</code></p>
        </div>
        </form>

                    <h2 id="posts-DELETEapi-posts--id-">Delete a post</h2>
